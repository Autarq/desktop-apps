...
en.extDOCXF =AUTARQ Office Form Template
en_GB.extDOCXF =AUTARQ Office Form Template
ar_SA.extDOCXF =قالب استبيان AUTARQ Office
bg.extDOCXF =AUTARQ Office Шаблон на формуляр
ca.extDOCXF =Plantilla de formulari AUTARQ Office
cs.extDOCXF =Šablona formuláře AUTARQ Office
el.extDOCXF =Πρότυπο φόρμας εγγράφου AUTARQ Office
;et.extDOCXF =AUTARQ Office dokumendi vormi mall
fi.extDOCXF =AUTARQ Office-asiakirjalomakemalli
;lt.extDOCXF =AUTARQ Office Anketos Šablonas
lo.extDOCXF =ຮູບແບບຂອງ AUTARQ Office
nl.extDOCXF =AUTARQ Office Formulier Sjabloon
ru.extDOCXF =Шаблон формы AUTARQ Office
de.extDOCXF =AUTARQ Office-Formularvorlage
fr.extDOCXF =Modèle de formulaire AUTARQ Office
es.extDOCXF =Plantilla de formulario AUTARQ Office
id.extDOCXF =Templat AUTARQ Office Form
it_IT.extDOCXF =Modello di modulo AUTARQ Office
pt_BR.extDOCXF =Modelo de formulário do AUTARQ Office
pt_PT.extDOCXF =Modelo de formulário AUTARQ Office
pl.extDOCXF =Szablon formularza AUTARQ Office
ro.extDOCXF =Șablon Formă AUTARQ Office
sk.extDOCXF =Šablóna formulára AUTARQ Office
sl.extDOCXF =AUTARQ Office predloga obrazca
sv.extDOCXF =AUTARQ Office formulärmall
tr.extDOCXF =AUTARQ Office Belgesi Form Şablonu
vi.extDOCXF =Mẫu biểu mẫu tài liệu AUTARQ Office
zh_CN.extDOCXF =AUTARQ Office表单模板
hy_AM.extDOCXF =AUTARQ Office փաստաթղթի ձևանմուշ
;hr.extDOCXF =AUTARQ Office Predložak obrasca
da.extDOCXF =AUTARQ Office formularskabelon
;hi.extDOCXF =ओनलीऑफिस दस्तावेज़ फॉर्म टेम्पलेट
hu.extDOCXF =AUTARQ Office formátum-sablon
;ga_IE.extDOCXF =Teimpléad Foirm AUTARQ Office
ja.extDOCXF =AUTARQ Office フォーム テンプレート
ko.extDOCXF =AUTARQ Office 문서 양식 템플릿
lv.extDOCXF =AUTARQ Office veidlapas veidne
no.extDOCXF =AUTARQ Office-dokumentskjemamal
uk.extDOCXF =Шаблон форми AUTARQ Office
be.extDOCXF =Шаблон формы AUTARQ Office
gl.extDOCXF =AUTARQ Office Modelo de Formulario
si.extDOCXF =ඔන්ලිඔෆිස් ආකෘතිපත්‍ර අච්චුව
zh_TW.extDOCXF =AUTARQ Office 文档表单模板
sr_Cyrl_RS.extDOCXF =AUTARQ Office формулар шаблон
sr_Latn_RS.extDOCXF =AUTARQ Office formular šablon
he.extDOCXF =תבנית טופס AUTARQ Office
sq.extDOCXF =Modeli i shablloni AUTARQ Office
#if Ver >= EncodeVer(6,1,1)
ur.extDOCXF =AUTARQ Office فارم ٹیمپلیٹ
#endif
