l10n.no = {
    welWelcome: 'Velkommen til __COMPANY_NAME__ redigeringsprogrammer for PC!',
    welDescr: 'Arbeid med dokumenter offline eller koble suiten til din skykonto: ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: 'Lag en __COMPANY_NAME__-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med __COMPANY_NAME__ skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en __COMPANY_NAME__-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for __COMPANY_NAME__. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i __COMPANY_NAME__-skyen og få tilgang til dem når som helst, fra hvor som helst.',
