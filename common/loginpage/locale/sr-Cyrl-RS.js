l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у AUTARQ Office Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај AUTARQ Office облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са AUTARQ Office Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај AUTARQ Office облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну AUTARQ Office облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у AUTARQ Office облаку и приступи им било када, са било ког места.',
