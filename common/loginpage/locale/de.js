l10n.de = {
    welWelcome: 'Willkommen in __COMPANY_NAME__ Desktop-Editoren!',
    welDescr: 'Arbeiten Sie offline an Dokumenten oder verbinden Sie die Suite mit Ihrer Cloud: ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: '__COMPANY_NAME__-Cloud erstellen',
    ...
    portalEmptyAdv1: 'Haben Sie noch kein Cloud-Konto? Wechseln Sie zum Onlinemodus mit dem __COMPANY_NAME__ Cloud Service und testen Sie die Möglichkeiten zur Zusammenarbeit  kostenlos.',
    ...
    linkCreatePortal: '__COMPANY_NAME__-Cloud erstellen',
    ...
    loginNoteAssignPhone: 'Die Zwei-Faktor-Authentifizierung ermöglicht zusätzliche __COMPANY_NAME__ Cloud Sicherheit. Geben Sie Ihre Handynummer ein, um die Arbeit am Cloud-Büro fortzusetzen. Die Handynummer muss in einem internationalen Format mit Ländervorwahl eingegeben werden.',
    ...
    emptySlide3Text: 'Speichern Sie Ihre Dokumente in der __COMPANY_NAME__-Cloud und greifen Sie darauf jederzeit von überall zu.',
