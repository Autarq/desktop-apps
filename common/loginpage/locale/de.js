l10n.de = {
    welWelcome: 'Willkommen in AUTARQ Office-Editoren!',
    welDescr: 'Ihr souveränes Office für lokale Dokumente und verbundene Clouds.',
    welNeedHelp: 'Brauchen Sie Hilfe? Besuchen Sie unser $1.',
    textHelpCenter: 'Projektseite',
    btnConnect: 'Zusammenarbeit',
    textHavePortal: 'Haben Sie Cloud schon benutzt?',
    btnCreatePortal: 'Mehr über AUTARQ Office erfahren',
    ...
    portalEmptyAdv1: 'AUTARQ Office arbeitet mit Ihrer verbundenen Cloud. Weitere Informationen zum Projekt und zu Integrationen finden Sie online.',
    ...
    linkCreatePortal: 'Mehr über AUTARQ Office erfahren',
    ...
    loginNoteAssignPhone: 'Die Zwei-Faktor-Authentifizierung ist für Ihre verbundene Cloud aktiviert. Geben Sie Ihre Handynummer ein, um die Arbeit am Cloud-Büro fortzusetzen. Die Handynummer muss in einem internationalen Format mit Ländervorwahl eingegeben werden.',
    ...
    emptySlide3Text: 'Speichern Sie Ihre Dokumente in Ihrer verbundenen Cloud und greifen Sie darauf jederzeit von überall zu.',
