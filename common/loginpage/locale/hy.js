l10n.hy = {
    welWelcome: 'Բարի գալուստ __COMPANY_NAME__ աշխատանքային սեղանի խմբագրիչներ',
    welDescr: 'Աշխատեք փաստաթղթերի վրա օֆֆլայն կամ միացրեք Ձեր փաթեթը Ձեր ամպին՝ ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: 'Ստեղծել __COMPANY_NAME__ ամպ',
    ...
    portalEmptyAdv1: 'Դեռևս չունե՞ք ամպային հաշիվ։ Դարձեք առցանց __COMPANY_NAME__ ամպային ծառայության հետ և <br />անվճար փորձեք համագործակցային հնարավորությունները։',
    ...
    linkCreatePortal: 'Ստեղծել __COMPANY_NAME__ ամպ',
    ...
    loginNoteAssignPhone: 'Երկու գործոնով վավերացումն միացված է, որպեսզի ապահովվի __COMPANY_NAME__ ամպի լրացուցիչ անվտանգություն։ Մուտքագրեք Ձեր հեռախոսահամարը, որպեսզի շարունակեք աշխատել ամպային office-ում։ Հեռախոսահամարը պետք է մուտքագրվի երկրի կոդով՝ ըստ միջազգային ֆորմատի։',
    ...
    emptySlide3Text: 'Պահպանեք Ձեր փաստաթղթերը __COMPANY_NAME__ ամպում, և դրանք հասանելի կլինի ցանկացած պահի ցանկացած վայրից։',
