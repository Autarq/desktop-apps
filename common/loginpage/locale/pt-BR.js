l10n.pt_BR = {
    ...
    welDescr: 'Trabalhe em documentos offline ou conecte-se à sua nuvem: ownCloud, Nextcloud and more.',
    welNeedHelp: 'Precisa de ajuda? Visite nossa $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Conectar',
    textHavePortal: 'Já usa o nuvem?',
    btnCreatePortal: 'Criar __COMPANY_NAME__ na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do __COMPANY_NAME__ gratuitamente.',
    ...
    linkCreatePortal: 'Criar __COMPANY_NAME__ na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do __COMPANY_NAME__. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do __COMPANY_NAME__ e acesse-os a qualquer momento, de qualquer lugar.',
