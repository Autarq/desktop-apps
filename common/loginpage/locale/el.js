l10n.el = {
    ...
    btnCreatePortal: 'Δημιουργήστε ένα __COMPANY_NAME__ cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία __COMPANY_NAME__ Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός __COMPANY_NAME__ cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο __COMPANY_NAME__ cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
