l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο AUTARQ Office!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα AUTARQ Office cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με AUTARQ Office και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός AUTARQ Office cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο AUTARQ Office cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
