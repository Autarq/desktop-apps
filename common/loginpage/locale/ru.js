l10n.ru = {
    welWelcome: 'Добро пожаловать в AUTARQ Office!',
    welDescr: 'Работайте с документами офлайн или подключитесь к облаку: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Создать облако AUTARQ Office',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом AUTARQ Office и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако AUTARQ Office',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке AUTARQ Office включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке AUTARQ Office и получайте к ним доступ в любое время, из любой точки мира.',
