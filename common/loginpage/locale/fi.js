l10n.fi = {
    welWelcome: 'Tervetuloa __COMPANY_NAME__ Työpöytä Editoriin!',
    welDescr: 'Työskentele ilman verkkoyhteyttä tai yhdistä pilveesi: ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: 'Luo __COMPANY_NAME__ pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon __COMPANY_NAME__N pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo __COMPANY_NAME__ pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa __COMPANY_NAME__N pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi __COMPANY_NAME__N pilveen ja käytä niitä million tahansa, missä tahansa.',
