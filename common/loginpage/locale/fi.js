l10n.fi = {
    welWelcome: 'Tervetuloa AUTARQ Office Työpöytä Editoriin!',
    welDescr: 'Työskentele ilman verkkoyhteyttä tai yhdistä pilveesi: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Luo AUTARQ Office pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon AUTARQ OfficeN pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo AUTARQ Office pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa AUTARQ OfficeN pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi AUTARQ OfficeN pilveen ja käytä niitä million tahansa, missä tahansa.',
