l10n.cs = {
    welWelcome: 'Vítejte v AUTARQ Office!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: AUTARQ Office, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit AUTARQ Office cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service AUTARQ Office a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit AUTARQ Office cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti AUTARQ Office cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
