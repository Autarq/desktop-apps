l10n.he = {
    welWelcome: 'ברוכים הבאים לעורכי שולחן העבודה של __COMPANY_NAME__!',
    welDescr: 'לעבוד על מסמכים במצב לא מקוון או לחבר את החבילה לענן שלך: ownCloud, Nextcloud and more.',
    welNeedHelp: 'צריך עזרה? בקר באתר שלנו ב-$1',
    textHelpCenter: 'מרכז עזרה',
    btnConnect: 'התחבר עכשיו',
    textHavePortal: 'כבר משתמשים בענן?',
    btnCreatePortal: 'צור ענן __COMPANY_NAME__',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם __COMPANY_NAME__ Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    linkCreatePortal: 'צור ענן __COMPANY_NAME__',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של __COMPANY_NAME__. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן __COMPANY_NAME__ וגש אליהם בכל עת ומכל מקום.',
