l10n.fr = {
    welWelcome: 'Bienvenue sur __COMPANY_NAME__ Desktop Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: 'Créer un compte Cloud __COMPANY_NAME__',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec __COMPANY_NAME__ et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud __COMPANY_NAME__',
    ...
    emptySlide3Text: 'Stockez vos documents dans __COMPANY_NAME__ Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
