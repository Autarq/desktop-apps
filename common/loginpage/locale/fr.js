l10n.fr = {
    welWelcome: 'Bienvenue sur AUTARQ Office !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud AUTARQ Office',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec AUTARQ Office et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud AUTARQ Office',
    ...
    emptySlide3Text: 'Stockez vos documents dans AUTARQ Office Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
