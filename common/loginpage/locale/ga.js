l10n.ga = {
    welWelcome: 'Fáilte chuig __COMPANY_NAME__ Eagarthóirí Deisce!',
    welDescr: 'Oibrigh ar dhoiciméid as líne nó ceangail an tsraith le do scamall: ownCloud, Nextcloud and more.',
    ...
    btnCreatePortal: 'Cruthaigh scamall __COMPANY_NAME__',
    ...
    portalEmptyAdv1: 'Nach bhfuil cuntas scamall agat fós? Téigh ar líne le __COMPANY_NAME__ Cloud Service agus <br /> bain triail as cumais chomhoibritheacha saor in aisce.',
    ...
    linkCreatePortal: 'Cruthaigh scamall __COMPANY_NAME__',
    ...
    loginNoteAssignPhone: 'Cumasaítear an fíordheimhniú dhá fhachtóir chun slándáil scamall __COMPANY_NAME__ a sholáthar. Cuir isteach d’uimhir fón póca chun leanúint ar aghaidh ag obair ar an oifig scamall. Ní mór uimhir fón póca a iontráil ag úsáid formáid idirnáisiúnta le cód tíre.',
    ...
    emptySlide3Text: 'Déan do chuid doiciméad a stóráil sa scamall __COMPANY_NAME__ agus rochtain a fháil orthu am ar bith, ó áit ar bith.',
