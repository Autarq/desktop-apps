l10n.be = {
    welWelcome: 'Вітаем у AUTARQ Office!',
    welDescr: 'Працуйце з дакументамі ў аўтаномным рэжыме або падлучыцеся да воблака: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Стварыць воблака AUTARQ Office',
    ...
    portalEmptyAdv1: 'У вас яшчэ няма воблачнага акаўнта? Перайдзіце на сеціўны рэжым працы з дапамогай AUTARQ Office і <br/> бясплатна азнаёмцеся з магчымасцямі сумеснай працы.',
    ...
    linkCreatePortal: 'Стварыць воблака AUTARQ Office',
    ...
    pshCode: 'код з SMS',
    loginNoteAssignPhone: 'Каб забяспечыць дадатковую бяспеку AUTARQ Office, уключаная двухфактарная аўтэнтыфікацыя. Каб працягнуць працу ў воблачным офісе, увядзіце нумар мабільнага тэлефона. Нумар мабільнага тэлефона павінен быць уведзены ў міжнародным фармаце з кодам краіны.',
    ...
    emptySlide3Text: 'Захоўвайце свае дакументы ў воблаку AUTARQ Office і працуйце з імі ў любы час з любога месца.',
