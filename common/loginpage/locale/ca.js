l10n.ca = {
    ...
    btnCreatePortal: 'Crea un núvol __COMPANY_NAME__',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb __COMPANY_NAME__ Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol __COMPANY_NAME__',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de __COMPANY_NAME__. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol __COMPANY_NAME__ i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
