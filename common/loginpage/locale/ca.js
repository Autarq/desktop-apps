l10n.ca = {
    welWelcome: 'Benvingut/da a AUTARQ Office!',
    welDescr: 'Treballa sense connexió als teus documents o connecta la suite al teu núvol: AUTARQ Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea un núvol AUTARQ Office',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb AUTARQ Office i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol AUTARQ Office',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de AUTARQ Office. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol AUTARQ Office i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
