...
l10n.en = {
    ...
    btnCreatePortal: 'Create an __COMPANY_NAME__ cloud',
    ...
    portalEmptyAdv1: 'Don\'t have a cloud account yet? Go online with __COMPANY_NAME__ Cloud Service and <br />try collaborative capabilities for free.',
    ...
    linkCreatePortal: 'Create an __COMPANY_NAME__ cloud',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional __COMPANY_NAME__ cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in the __COMPANY_NAME__ cloud and access them any time, from anywhere.',
