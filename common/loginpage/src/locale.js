...
var l10n = l10n || {};
l10n.en = {
    welWelcome: 'Welcome to AUTARQ Office!',
    ...
    btnCreatePortal: 'Learn more about AUTARQ Office',
    ...
    portalEmptyAdv1: 'AUTARQ Office works with your connected cloud. Learn more about the project and integrations.',
    ...
    linkCreatePortal: 'Learn more about AUTARQ Office',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled for your connected cloud. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in your connected cloud and access them any time, from anywhere.',
